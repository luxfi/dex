...
\title{\textbf{LX: A 100M+ Trades/Second Decentralized Exchange} \\
...
\begin{itemize}
    ...
    \item \textbf{Quantum resistance} via Corona+BLS hybrid signatures
...
\begin{itemize}
    \item \textbf{Corona}: Post-quantum lattice-based threshold signatures (Lux production fork of the two-round Ringtail construction, IACR ePrint 2024/1113)
...
\textbf{LX} & \textbf{100M+/s} & \textbf{597ns} & \textbf{Yes} \\
\bottomrule
\end{tabular}
\caption{LX exceeds CEX performance while maintaining decentralization}
\end{table}
