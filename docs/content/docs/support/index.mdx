---
title: Support Guide
description: Get help with LX DEX - troubleshooting, FAQs, and support resources
---

# Support Guide

This guide helps you resolve common issues and get support for LX DEX.
...
- **Verify URLs** - only use official LX DEX endpoints
...
```
□ Is the LX DEX daemon (lxd) running?
