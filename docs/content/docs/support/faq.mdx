---
title: FAQ
description: Frequently asked questions about LX DEX trading, APIs, and integration
---
...
LX DEX is a high-performance decentralized exchange built on the Lux blockchain. It features:
...
### How is LX DEX different from other DEXs?

| Feature | LX DEX | AMM DEXs | Other Order Book DEXs |
|---------|--------|----------|----------------------|
...
### What consensus does LX DEX use?
...
1. Order matched in DEX sidecar (sub-millisecond)
2. Settlement message sent via Warp
3. On-chain confirmation (1ms finality)
4. Balances updated atomically

### Is the order book really on-chain?

Yes. Every order, cancel, and trade is recorded on-chain with full transparency. The matching engine runs as a sidecar for performance but settlement is atomic and on-chain.

### What about MEV?

LX DEX has built-in MEV protection:
...
LX DEX uses wallet-based authentication. Connect your wallet to start trading:
