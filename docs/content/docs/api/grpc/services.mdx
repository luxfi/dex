...
description: Complete reference for all LX DEX gRPC services and RPC methods
---

# gRPC Services Reference

The LX DEX exposes a unified `LXDEXService` with methods organized into four categories: Order Management, Market Data, Account Management, and Node Management.
