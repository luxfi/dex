---
title: WebSocket API
description: Real-time WebSocket API for LX DEX - connection, authentication, and streaming data
---
...
The LX DEX WebSocket API provides real-time, bidirectional communication for market data and trading operations. All messages use JSON encoding with strict ordering guarantees.
