...
description: Quantum-resistant cryptography implementation with Dilithium, Kyber, and Corona for LX DEX
---

# Post-Quantum Cryptography

LX DEX implements NIST-approved post-quantum cryptographic algorithms to protect against future quantum computer attacks. Our hybrid approach provides security against both classical and quantum adversaries.
...
| ML-DSA-65 | Level 3 | 3,309 bytes | 1,952 bytes | **LX DEX default** |
...
Corona is LX DEX's custom lattice-based threshold signature scheme, enabling MPC signing with quantum resistance.
...
For Warp cross-chain messaging, LX DEX uses hybrid BLS+Corona signatures:
