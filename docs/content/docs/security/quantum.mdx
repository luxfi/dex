...
description: Quantum-resistant cryptography implementation with Dilithium, Kyber, and Ringtail for LX DEX
---
...
Ringtail is LX DEX's custom lattice-based threshold signature scheme, enabling MPC signing with quantum resistance.
...
For Warp cross-chain messaging, LX DEX uses hybrid BLS+Ringtail signatures:
