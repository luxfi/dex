---
title: MPC Security
description: Multi-Party Computation security, threshold signatures, and key ceremonies for LX DEX
---

# MPC Security

LX DEX uses Multi-Party Computation (MPC) for secure key management, ensuring no single party can access complete private keys. This enables trustless custody while maintaining operational flexibility.
