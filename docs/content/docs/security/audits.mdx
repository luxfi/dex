...
description: Security audit history, bug bounty program, and responsible disclosure for LX DEX
---

# Security Audits

LX DEX maintains rigorous security through regular third-party audits, an active bug bounty program, and transparent disclosure processes.
