...
description: Get free test tokens for development on LX DEX Testnet
---

# Testnet Faucet

The LX DEX Testnet Faucet provides free test tokens for development and testing. Tokens have no monetary value and are intended solely for integration testing.
