...
> **Package**: [`lux-dex`](https://pypi.org/project/lux-dex/) | **Source**: [GitHub](https://github.com/luxfi/dex/tree/main/sdk/python) | **Specification**: [LP-9002](https://github.com/luxfi/LPs/blob/main/LPs/lp-9002-dex-api-rpc-specification.md)
