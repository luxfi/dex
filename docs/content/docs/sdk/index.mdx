...
|-----|---------|---------|--------|
| TypeScript (base) | `@luxfi/dex` | [GitHub](https://github.com/luxfi/dex/tree/main/sdk/typescript) | Complete |
| TypeScript (trading) | `@luxfi/trading` | [GitHub](https://github.com/luxfi/dex/tree/main/sdk/lx-trading-ts) | Complete |
| Python | `lux-dex` | [GitHub](https://github.com/luxfi/dex/tree/main/sdk/python) | Complete |
| Go | `github.com/luxfi/dex/sdk/go` | `go get` | Complete |
| Rust | `lux-dex` | [GitHub](https://github.com/luxfi/dex/tree/main/sdk/rust) | Complete |
| C | `lxdex` | [GitHub](https://github.com/luxfi/dex/tree/main/sdk/c) | Complete |
| C++ | `lxdex` | [GitHub](https://github.com/luxfi/dex/tree/main/sdk/cpp) | Complete |
...
npm link  # Makes @luxfi/dex available globally

# Trading SDK (for bots and trading strategies)
cd sdk/lx-trading-ts && npm install && npm run build
npm link  # Makes @luxfi/trading available globally

# In your project
npm link @luxfi/dex @luxfi/trading
```
...
pip install git+https://github.com/luxfi/dex.git#subdirectory=sdk/python
```
...
```bash
# From GitHub (add to Cargo.toml)
[dependencies]
lux-dex = { git = "https://github.com/luxfi/dex", branch = "main" }
