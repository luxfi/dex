...
|-----|---------|-------------|--------|
| TypeScript (base) | [`@luxfi/dex`](https://npmjs.com/package/@luxfi/dex) | Core SDK - Client, types, low-level API | Complete |
| TypeScript (trading) | [`@luxfi/trading`](https://npmjs.com/package/@luxfi/trading) | Trading bots - DEX(), AMM(), CCXT integration | Complete |
| Python | [`lux-dex`](https://pypi.org/project/lux-dex/) | Full-featured Python SDK | Complete |
| Go | `github.com/luxfi/dex/sdk/go` | High-performance Go SDK | Complete |
| Rust | [`lux-dex`](https://crates.io/crates/lux-dex) | Systems programming SDK | Complete |
