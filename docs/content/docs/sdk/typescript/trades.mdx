...
```typescript
import { LXDexClient, Trade } from '@luxfi/dex-sdk';
...
```typescript
import { LXDexClient, Trade, OrderSide } from '@luxfi/dex-sdk';
...
```typescript
import { Trade } from '@luxfi/dex-sdk';
...
import { Trade, OrderSide } from '@luxfi/dex-sdk';
