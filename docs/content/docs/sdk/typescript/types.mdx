...
description: Complete TypeScript type definitions and interfaces for the LX DEX SDK
---

# Type Reference

Complete reference of all TypeScript types, interfaces, and enums exported by `@luxfi/dex-sdk`.
...
Main client class for interacting with LX DEX.
