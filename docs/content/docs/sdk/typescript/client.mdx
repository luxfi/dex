...
The `LXDexClient` class is the main entry point for interacting with LX DEX. This guide covers all configuration options and initialization patterns.
...
class TradingBot {
  ...
  async disconnect(): Promise<void> {
    ...
    console.log('Disconnected from LX DEX');
  }
