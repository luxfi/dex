---
title: C SDK
description: Pure C SDK for LX DEX - FFI bindings, embedded systems, and cross-platform integration
---
...
The LX DEX C SDK provides a pure C11 interface for building trading applications. Designed for embedded systems, FFI bindings to other languages, and environments where C++ is unavailable.
...
LxDex.lxdex_init
puts "LX DEX SDK version: #{LxDex.lxdex_version}"
