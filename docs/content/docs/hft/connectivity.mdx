...
LX DEX provides multiple connectivity tiers optimized for different latency and throughput requirements.
...
The lowest latency option - direct single-mode fiber from your rack to the LX DEX matching engine.
...
```cpp
// RDMA connection setup for LX DEX
...
```cpp
// DPDK initialization for LX DEX
#include <rte_eal.h>
...
router bgp 65002  # Your ASN
  neighbor 10.0.0.1 remote-as 65001  # LX DEX ASN
...
```yaml
# SD-WAN configuration for LX DEX
network:
...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  Your Infrastructure                LX DEX Infrastructure   │
│                                                              │
│  ┌──────────────┐                   ┌──────────────────┐    │
