...
The LX DEX margin trading system enables leveraged perpetual trading up to 50x with cross-margin and isolated margin modes, advanced order types, and real-time liquidation protection.
