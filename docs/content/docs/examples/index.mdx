---
title: Examples
description: Complete, production-ready trading examples for LX DEX
---

# Trading Examples

Complete, copy-paste ready examples for building trading systems on LX DEX.

## Quick Start

All examples connect to LX DEX and demonstrate real trading patterns. Before running:

```bash
# Start local LX DEX node
cd /path/to/lx/dex
make build
