...
|---------|----------|-----|----------|
| Lux Mainnet | 96369 | `https://api.lux.network/v1/chain/C/rpc` | `https://explorer.lux.network` |
| Lux Testnet | 96368 | `https://api.lux-test.network/v1/chain/C/rpc` | `https://explore.lux-test.network` |
