...
description: Get started with Hummingbot and LX DEX in 5 minutes
---

# Hummingbot Quick Start

Get your first trading bot running on LX DEX in under 5 minutes.
...
## Step 2: Install LX DEX Connector

```bash
# Install the LX DEX Gateway connector
cd gateway
npm install @lxdex/hummingbot-gateway-connector
```

## Step 3: Configure LX DEX
...
| Command | Description |
|---------|-------------|
| `connect lxdex` | Connect to LX DEX |
