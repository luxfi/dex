...
description: Official LX DEX connector for Hummingbot Gateway
---

# Hummingbot Integration

[Hummingbot](https://hummingbot.org) is the most popular open-source trading bot software, used by thousands of traders and market makers worldwide. LX DEX provides an official Gateway connector enabling automated trading on our ultra-low latency DEX.

## Features

Our Hummingbot Gateway connector supports all four LX DEX trading schemas:
