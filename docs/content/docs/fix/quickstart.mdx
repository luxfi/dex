...
description: Connect to LX DEX via FIX protocol in 15 minutes
---

# FIX Quick Start

Get connected to LX DEX via FIX protocol in 15 minutes.
...
| TargetCompID | LX DEX identifier | `LXDEX` |
...
Download the LX DEX FIX data dictionary:
