...
description: Complete guide to trading on LX DEX - spot, perpetuals, margin, and advanced order types
---
...
LX DEX provides institutional-grade trading infrastructure with sub-microsecond latency and 434M+ orders per second throughput.
...
| [Options](/docs/trading/options) | Options contracts | Variable | Expiration |
...
const stopOrder = await dex.placeOrder({
  symbol: 'BTC-USD',
  side: 'sell',
  type: 'stop',
  stopPrice: '45000',
