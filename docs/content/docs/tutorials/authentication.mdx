...
description: Configure API keys, JWT tokens, and secure connections for LX DEX - complete security guide
---

# Authentication Setup

This tutorial covers all authentication methods for LX DEX, from API keys to JWT tokens and secure WebSocket connections.
