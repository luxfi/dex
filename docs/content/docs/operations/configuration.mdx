---
title: Configuration
description: Complete configuration reference for LX DEX
---

# Configuration

LX DEX supports configuration via YAML files, environment variables, and command-line flags. This reference covers all available options.
...
```yaml
# /etc/lxdex/node.yaml
# LX DEX Configuration Reference
