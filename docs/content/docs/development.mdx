...
description: Build, test, and contribute to LX DEX
---

# LX DEX Development Guide

> **Specification**: [LP-0050 Developer Tools Overview](https://github.com/luxfi/LPs/blob/main/LPs/lp-0050-developer-tools-overview.md) | [LP-0006 Network Runner and Testing Framework](https://github.com/luxfi/LPs/blob/main/LPs/lp-0006-network-runner-and-testing-framework.md) | [Discussions](https://github.com/luxfi/LPs/discussions)
>
