...
// The dexcore error set. Each names a fail-closed condition: when settlement
...
var (
	...
	ErrInsufficientAvailable = errors.New("dexcore: insufficient available balance")
	...
	ErrInsufficientLocked = errors.New("dexcore: insufficient locked balance")
	...
	ErrMissingSettlementUser = errors.New("dexcore: resting order has no full settlement identity (orderuser: row missing)")
	...
	ErrFillMissingUnits = errors.New("dexcore: fill missing integer units (BaseUnits/QuoteUnits)")
	...
	ErrFillUnitsOverflow = errors.New("dexcore: fill integer units exceed uint64")
	...
	ErrDustPriceOrZeroLock = errors.New("dexcore: executable order locks zero (dust price or sub-unit size)")
	...
	ErrUnknownMarket = errors.New("dexcore: market has no asset binding")
	...
	ErrNoLiquidity = errors.New("dexcore: no liquidity across any source for this swap")
	...
	ErrPriceLimit = errors.New("dexcore: realized price violates taker price limit")
	...
	ErrBuyRequiresLimit = errors.New("dexcore: exact-input BUY requires a price limit (unbounded-slippage market buy refused)")
)
