...
extern void* const lux_dex_secp256k1_metal_anchor;
...
// dlsym's at runtime.
static inline void* lux_dex_secp256k1_metal_anchor_keep(void) {
    return lux_dex_secp256k1_metal_anchor;
}
*/
import "C"
...
// linker DCE.
var metalAnchorAddr = C.lux_dex_secp256k1_metal_anchor_keep()
